...
#define __VECTORS_H
    ...
    extern void PORTA_Interrupt();
    extern void PORTB_Interrupt();
    extern void PORTC_Interrupt();
    extern void PORTD_Interrupt();
    extern void PORTE_Interrupt();

    extern void PIT0_Interrupt();
    extern void PIT1_Interrupt();
    extern void PIT2_Interrupt();
    extern void PIT3_Interrupt();
    ...
    #define VECTOR_020      DMA_CH4_Handler // 0x0000_0050 20     4     DMA              DMA Channel 4 transfer complete
    ...
    #define VECTOR_046      default_isr     // 0x0000_00B8 46    30     --               空
    ...
    #define VECTOR_058      FTM0_interrupt  // 0x0000_00E8 58    42     FTM0             Single interrupt vector for all sources
    #define VECTOR_059      FTM1_interrupt  // 0x0000_00EC 59    43     FTM1             Single interrupt vector for all sources
    #define VECTOR_060      FTM2_interrupt  // 0x0000_00F0 60    44     FTM2             Single interrupt vector for all sources
    ...
    #define VECTOR_064      PIT0_Interrupt  // 0x0000_0100 64    48     PIT              Channel 0
    #define VECTOR_065      PIT1_Interrupt  // 0x0000_0104 65    49     PIT              Channel 1
    #define VECTOR_066      PIT2_Interrupt  // 0x0000_0108 66    50     PIT              Channel 2
    #define VECTOR_067      PIT3_Interrupt  // 0x0000_010C 67    51     PIT              Channel 3
    ...
    #define VECTOR_071      default_isr     // 0x0000_011C 71    55     --               空
    #define VECTOR_072      default_isr     // 0x0000_0120 72    56     DAC0
    #define VECTOR_073      default_isr     // 0x0000_0124 73    57     MCG
    #define VECTOR_074      LPTMR_Interrupt // 0x0000_0128 74    58     Low Power Timer
    #define VECTOR_075      PORTA_Interrupt // 0x0000_012C 75    59     Port control module    Pin detect (Port A)
    #define VECTOR_076      PORTB_Interrupt // 0x0000_0130 76    60     Port control module    Pin detect (Port B)
    #define VECTOR_077      PORTC_Interrupt // 0x0000_0134 77    61     Port control module    Pin detect (Port C)
    #define VECTOR_078      PORTD_Interrupt // 0x0000_0138 78    62     Port control module    Pin detect (Port D)
    #define VECTOR_079      PORTE_Interrupt // 0x0000_013C 79    63     Port control module    Pin detect (Port E)
    ...
    #define VECTOR_082      UART4_IRQHandler// 0x0000_0148 82    66     UART4                  Single interrupt vector for UART status sources
    ...
    #define VECTOR_101      default_isr     // 0x0000_0194 101   85     Ethernet MAC           Error and miscellaneous interrupt
    #define VECTOR_102      default_isr     // 0x0000_0198 102   86     LPUART0	               Status and error
    #define VECTOR_103      abort_isr       // 0x0000_019C 103   87     TSI0
